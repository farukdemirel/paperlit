...
class PaperLitAppTest {
    ...
    fun productFormCalculatesSamplePackage() {
        ...
        composeRule.onNodeWithText("Hesap sonucu")
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText("Toplam yaprak: 2.400")
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText("Rulo başına: 15,00 TL")
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText("100 yaprak: 10,00 TL")
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText("Kat eşdeğerli 1 m²: 2,92 TL")
            .performScrollTo()
            .assertIsDisplayed()
    }
}
